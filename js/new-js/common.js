...
(function print() {
    ...
    function insertChat(who, text) {
        ...
        if (who == "me") {
            ...
            if (original) {
                control = '<li style="width:100%;">' + '<div class="note"></div>' + '<div class="msj-rta macro">' + '<div class="text text-r">' + '<p>' + text + '</p>' + '<p><small>' + date + '</small></p>' + '</div>' + '<div class="avatar" style="padding:0px 0px 0px 10px !important"><img class="img-circle" style="width:100%;" src="' + you.avatar + '" /></div>' + '</li>';
            } else {
    ...
    var phrases = {
        'привет': 'Здравствуйте.',
        'как дела': 'отлично',
        'меня тоже': 'что хочешь узнать',
        'отследить': 'Введите код Вашей посылки',
        'розка карт': 'Карта дает вам скидки на все услуги компании, обычная 5%, серебряная 10%, золотая 15%',
        'как мне возобновить карту': 'Чтобы возобновить карту подзвоните менеджеру',
        'получить карт': 'Карту можно получить после первой покупки на соответствующую сумму <br> [похожее: золотая карта, серебряная карта]',
        'карт серебр': 'Серебряная карта выдается при сумарной суме покупок больше чем на 10 000',
        'карт золот': 'Золотая карта выдается при сумарной суме покупок больше чем на 10 000',
